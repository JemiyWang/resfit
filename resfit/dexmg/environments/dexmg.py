...
# cuda_to_egl_device_id / VectorizedEnvWrapper 已抽到 robosuite-无关模块
# resfit.rl_finetuning.chunk_residual.vec_env_util(让 libero 路在 robosuite-1.4
# env 里也能复用而不触发本文件顶层的 robosuite-1.5 import)。这里原样 re-import
# 保持 dexmg 行为/对外符号不变。说明见该模块及 tools/egl_gpu_map.py。
from resfit.rl_finetuning.chunk_residual.vec_env_util import (  # noqa: E402
    cuda_to_egl_device_id,
...
# VectorizedEnvWrapper 已抽到 resfit.rl_finetuning.chunk_residual.vec_env_util,
# 见文件顶部 re-import(本文件对外符号不变)。
